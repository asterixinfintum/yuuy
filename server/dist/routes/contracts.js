...
var contractRoute = (0, _express["default"])();
contractRoute.get('/zhgwnwhemvduhw', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          console.error('Error retrieving contract items:', _context.t0);
          //throw error;
          res.status(500).json({
